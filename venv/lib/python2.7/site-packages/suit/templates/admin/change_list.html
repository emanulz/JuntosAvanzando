      ...
      <div class="module{% if cl.has_filters %} filtered{% endif %}" id="changelist">
        ...
        {% if cl.formset.errors %}
          <div class="alert alert-error errornote">
            {% blocktrans count cl.formset.errors|length as counter %}Por favor corrija el siguiente error.{% plural %}Por favor corrija los siguientes errores.{% endblocktrans %}
          </div>
            ...
            {% else %}
              ...
              <div class="alert alert-block alert-info">
                {% if cl.full_result_count %}
                  <h4>{% trans 'No encontrado' %}!</h4>
                  <br>
                  <a href="?{% if cl.is_popup %}{{ POPUP_VAR }}=1{% endif %}">{% trans 'Limpiar búsqueda y filtros' %}</a>
                {% else %}
                  {% blocktrans with cl.opts.verbose_name_plural|capfirst as name_plural %}{{ name_plural }} en blanco {% endblocktrans %}.
