...
{% block extrajs %}
  ...
  {% if 'CONFIRM_UNSAVED_CHANGES'|suit_conf %}
    ...
    <script type="text/javascript">
      confirmExitIfModified('{{ opts.module_name }}_form', '{% trans 'No ha guardado los cambios' %}.');
    </script>
  {% endif %}
        ...
        <div class="tab-content tab-content-main">
          ...
          {% if errors %}
            <div class="alert alert-error">
              {% blocktrans count counter=errors|length %}Por favor corrija el siguiente error.{% plural %} Por favor corrija los siguiente errores.{% endblocktrans %}
